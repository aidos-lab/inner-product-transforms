...
for _ in range(10):
    noised_ect = noised_ect + 0.05 * torch.randn_like(noised_ect)
...
df2.to_csv(f"./results/noise_gaussian.csv")

torch.save(vis_x, f"./results/noise_gaussian_vis_x.pt")
torch.save(vis_ect, f"./results/noise_gaussian_vis_ect.pt")
