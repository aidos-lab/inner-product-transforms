"""
A normalized version of the ShapeNet dataset.
Each element in the dataset is normalized to
lie exactly have unit randius.
"""
...
from shapesynthesis.datasets.transforms import CenterTransform, EctTransform
...
def get_datasets(cates, root_dir):
    ...
    def prepare_data(self):
        ShapeNetDataset(
            ...
            pre_transform=Compose(
                [CenterTransform(), EctTransform(self.config.ectconfig)]
            ),
