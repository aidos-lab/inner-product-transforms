"""
This script evaluates the inference times of the ECT over various ect sizes and
compares a compiled vs non-compiled version. 
...
def run_timing(
    ...
    for _ in range(warmup_runs):
        ...
        out, elapsed = timed(lambda: ect_fn(x_gt, **ectkwargs))
